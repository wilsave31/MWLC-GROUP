 ...
 * Generated at: 2021-10-21 03:50:43 UTC
...
public final class usuarioActualizar_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (sesion.getAttribute("usuario")==null) response.sendRedirect("index.jsp?mensaje=Acceso no autorizado");
    ...
    response.sendRedirect("principal.jsp?CONTENIDO=usuario/usuario.jsp&id="+variables.get("id"));
      ...
      out.write("window.location=\"principal.jsp?CONTENIDO=usuario/usuario.jsp&id=");
